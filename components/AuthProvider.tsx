...
export default function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const publicRoutes = ["/login", "/register", "/proyectar", "/musicos", "/unirse", "/bienvenido", "/en-vivo-lab", "/ver"]
  ...
  const RUTAS_SOLO_LIDER = ["/control", "/canciones", "/historial", "/transmision", "/en-vivo", "/camara"] // líder + admin
