...
export default function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const publicRoutes = ["/login", "/register", "/proyectar", "/musicos", "/unirse", "/bienvenido", "/ver"]
  ...
  const RUTAS_SOLO_LIDER = ["/control", "/canciones", "/historial", "/transmision", "/en-vivo", "/en-vivo-lab", "/camara", "/camara-lab"] // líder + admin
