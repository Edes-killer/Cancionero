...
export default function InicioPage() {
  ...
  // ✅ La "Cámara para transmisión" solo tiene sentido en el CELULAR (APK): el
        ...
        <div style={{ padding:"20px 16px", display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div data-tour="inicio-modulos" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
            {[
              ...
              { icon:"🎥", label:"Transmitir",       sub:"Consola de transmisión en vivo", border:"rgba(245,158,11,0.3)", bg:"rgba(245,158,11,0.08)", ibg:"rgba(245,158,11,0.2)", action:() => window.open(`${window.location.origin}/en-vivo`, "selah-transmision"), soloLider:true, soloPremium:true },
            ...
            ].filter(t => (!(t as any).soloAdmin || rol === null || rol === "admin") && (!(t as any).soloLider || rol === null || rol === "admin" || rol === "lider") && (!(t as any).soloApp || esApp) && (!(t as any).soloPremium || plan === "premium")).map(({ icon, label, sub, border, bg, ibg, action }) => (
