    ...
    return (
      <div style={s.root}>
        ...
        <div style={{ ...s.card, maxWidth: 400, textAlign: "center", padding: "40px 28px" }}>
          ...
          <button
            onClick={() => { setEnviado(false); setEmail(""); setCargando(false); setError("") }}
    ...
    <div style={s.root}>
      ...
      <div style={s.wrapper}>
        ...
        <div style={{ ...s.card, width: "100%" }}>
          ...
          <p style={{ margin: "0 0 22px", opacity: 0.45, fontSize: 13 }}>
          ...
          <button
            ...
            style={{
              ...s.btnPrimary,
              opacity: cargando || !email.trim() ? 0.55 : 1,
              cursor: cargando || !email.trim() ? "not-allowed" : "pointer"
            }}
          >
  ...
  return (
    <Suspense fallback={
      <div style={{ minHeight: "100dvh", background: "#060d1a", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: 48, height: 48, borderRadius: "50%", border: "4px solid rgba(255,255,255,0.1)", borderTopColor: "#3b82f6", animation: "spin 0.8s linear infinite" }} />
